...
public class PrgState {
    ...
    private IMyLockTable lockTable;
    IStmt originalProgram; // optional field but good to have

    public PrgState(IMyStack<IStmt> stk, IMyDictionary<String, Value> symtbl, IMyList<Value> ot,IFileTable<StringValue, BufferedReader> fT, IMyHeap heap, IStmt stmt, IMyLockTable lockTable){
        id = setId();
        executionStack = stk;
        symTable = symtbl;
        out = ot;
    ...
    public IMyLockTable getLockTable(){
        return lockTable;
    }

    public void setLockTable(IMyLockTable lockTable){
        this.lockTable = lockTable;
    }
